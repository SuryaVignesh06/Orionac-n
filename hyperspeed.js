...
import { BloomEffect, EffectComposer, EffectPass, RenderPass, SMAAEffect, SMAAPreset } from 'https://esm.sh/postprocessing';
...
const DEFAULT_EFFECT_OPTIONS = {
    ...
    colors: {
        roadColor: 0x526344,
        islandColor: 0x657930,
        background: 0,
        shoulderLines: 0x1250072,
        brokenLines: 0x1250072,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (container) {
        const app = new App(container, DEFAULT_EFFECT_OPTIONS);
        app.init();
    }
});
